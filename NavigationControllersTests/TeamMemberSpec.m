...
describe(@"TeamMember", ^{
    ...
    describe(@"Initializer", ^{
        ...
        it(@"should set properties to default values ", ^{
            ...
            pending(@"wait for it..", ^{ //techinically this doesn't work because each UIImage has a different memeory address so we'll omit this test by wrapping in a pending block
